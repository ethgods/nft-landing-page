...
async function loadInfo() {
  ...
  window.mintPrice = 0.005;//await contract.methods.getPrice(1).call();
...
function setTotalPrice() {
  ...
  const price = window.mintPrice * mintInputValue; //web3.utils.fromWei(totalPriceWei.toString(), 'ether');
